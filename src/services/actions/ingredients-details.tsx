...
export const addIngredientsDetails = (card : any) => ({ type: ADD_INGREDIENTS_DETAILS, payload: card });
...
interface IAddIngredientAction {
  ...
  export type TIngredientDetailsActions = IAddIngredientAction | IDeleteIngredientAction;